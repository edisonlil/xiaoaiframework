...
public class ResultBean<T> {
     ...
     * @return 当前对象
     */
    public static ResultBean illegalArgument() {
        return new ResultBean(BaseCode.illegalArgument).setMessage(BaseCode.illegalArgument.getCodeExplain());
    }
